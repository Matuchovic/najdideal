    ...
    <div style={{background:'#020208',color:G.wht,fontFamily:'Syne,sans-serif',overflowX:'hidden'}}>
      ...
      <section className="hero-grid" style={{
        ...
        <div style={{position:'relative',zIndex:10}}>
          ...
          <div id="nd-headline" style={{fontFamily:'Bebas Neue,sans-serif',fontSize:'clamp(64px,10vw,140px)',lineHeight:.86,letterSpacing:4,marginBottom:20,overflow:'hidden',position:'relative'}}>
