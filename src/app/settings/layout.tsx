...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-void-1000">
      <style>{`
        .dn{height:56px;border-bottom:1px solid rgba(255,255,255,.06);background:rgba(2,2,8,.85);backdrop-filter:blur(20px);display:flex;align-items:center;padding:0 16px;gap:8px;overflow:hidden;position:relative}
